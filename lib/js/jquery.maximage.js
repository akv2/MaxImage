...
*/
/*!	
 * Maximage Version: 2.0.61 (01-Oct-2012) - http://www.aaronvanderzwan.com/maximage/2.0/
 */
					...
					if($.Slides.length > 0){					
						for(var q in $.Slides) {
							...
							$img.load(function() {
								...
								// Show image so we can get our sizes
								$loaded.show();
								...
								// Add it to DOM
								$loaded.prependTo($('div.mc-image-n' + q));
								
								// Empty our loader
								$('div.mc-loader').html('');
								
								// If it's the last image
								if(q == ($.Slides.length - 1)) {
									// Remove our loader element because all of our images are now loaded
									$('div.mc-loader').remove();
									alert('here = ' + $.Slides[q].url)
									// If we have just loaded the final image, run the user defined function onImagesLoaded()
									config.onImagesLoaded();
								}
